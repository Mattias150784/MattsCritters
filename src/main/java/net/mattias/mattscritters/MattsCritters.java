package net.mattias.mattscritters;
...
@Mod(MattsCritters.MOD_ID)
public class MattsCritters
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "mattscritters";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public MattsCritters()
    {
